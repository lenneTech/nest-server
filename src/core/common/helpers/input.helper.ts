...
export class InputHelper {
  ...
  public static isArray(parameter: any, falseFunction: Function = InputHelper.errorFunction): boolean {
    return parameter !== null && typeof parameter !== 'undefined' && parameter.constructor === Array ? true : falseFunction(InputHelper.isArray);
  }
   ...
   */
  public static isBetween(parameter: number, min: number, max: number, falseFunction: Function = InputHelper.errorFunction): boolean {
    return typeof parameter === 'number' && parameter > min && parameter < max ? true : falseFunction(InputHelper.isBetween);
  }
  ...
  public static isFile(parameter: any, falseFunction: Function = InputHelper.errorFunction): boolean {
    return parameter !== null && typeof parameter !== 'undefined' && parameter.name && parameter.path &&
    parameter.type && parameter.size > 0 ? true : falseFunction(InputHelper.isFile);
  }
   ...
   */
  public static isGreater(parameter: number, compare: number, falseFunction: Function = InputHelper.errorFunction): boolean {
   ...
   */
  public static isLower(parameter: number, compare: number, falseFunction: Function = InputHelper.errorFunction): boolean {
  ...
  public static isNonEmptyArray(parameter: any, errorFunction: Function = InputHelper.errorFunction): boolean {
    return parameter !== null && typeof parameter !== 'undefined' && parameter.constructor === Array && parameter.length > 0 ?
      true : errorFunction(InputHelper.isNonEmptyArray);
  }
  ...
  public static isNonEmptyObject(parameter: any, falseFunction: Function = InputHelper.errorFunction): boolean {
    ...
    Object.keys(parameter).length !== 0 ? true : falseFunction(InputHelper.isNonEmptyObject);
  }
  ...
  public static isObject(parameter: any, falseFunction: Function = InputHelper.errorFunction): boolean {
    return parameter !== null && typeof parameter !== 'undefined' && parameter.constructor === Object ? true : falseFunction(InputHelper.isObject);
  }
