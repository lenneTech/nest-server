...
/** Input for updating a {@link CoreAiPromptSnippet}. All fields optional. */
@InputType({ description: 'Input to update a user prompt snippet' })
@Restricted(RoleEnum.S_USER)
export class CoreAiPromptSnippetInput extends CoreInput {
  @UnifiedField({ description: 'The snippet text', isOptional: true, roles: RoleEnum.S_USER })
