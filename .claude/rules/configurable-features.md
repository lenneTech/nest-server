...
|--------|--------|-------------|
| `ai` | `budgetService`, `connectionResolver`, `connectionService`, `controller`, `conversationService`, `interactionService`, `preferenceService`, `promptBuilder`, `promptHintService`, `promptTemplateService`, `resolver`, `service` | Custom AI orchestrator, connection-resolution chain, connection/preference/budget/conversation/interaction services, prompt-template + learning-hint stores, endpoints |
