...
|--------|--------|-------------|
| `ai` | `budgetService`, `connectionResolver`, `connectionService`, `controller`, `conversationService`, `interactionService`, `preferenceService`, `promptBuilder`, `resolver`, `service` | Custom AI orchestrator, connection-resolution chain, connection/preference/budget/conversation/interaction services, endpoints |
