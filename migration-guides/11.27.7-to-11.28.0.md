...
Then work through the four breaking changes below. If your project never asserts 401 on an
authenticated request and never matches on permission-error message text, there is nothing to do.
