...
| **New Features** | **Zero-Config Passkey**, URL Auto-Detection, Database Challenge Storage (JWT mode), Logging helpers, BetterAuthTokenService, registerRolesGuardGlobally |
...
**Why:** Without this option, `@Roles()` decorators are not enforced in IAM-only mode.
